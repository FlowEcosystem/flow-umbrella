...
export const enrollmentTokensApi = {
  list:   ()       => http.get('/v1/enrollment-tokens').then(r => r.data),
  create: (data)   => http.post('/v1/enrollment-tokens', data).then(r => r.data),
  revoke: (id)     => http.delete(`/v1/enrollment-tokens/${id}`),
}
